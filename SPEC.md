# MG Invoice — iOS App Spec

Build a native iOS invoice generator app called **MG Invoice**. No account, no backend, no network requests. Everything lives on-device. The app lets users fill out an invoice form, see a live PDF-quality preview, and export the invoice as a PDF to share or save.
...
- **App name:** MG Invoice
- **Bundle ID:** app.mg-invoice (or similar)
- **Minimum iOS:** 17
