...
- 2 currencies supported (USD, PHP)
- VAT / tax rate field
...
components/
  mg-invoice-preview.tsx   # A4 invoice preview with print support
  ui/                   # shadcn/ui components
lib/
  types.ts              # Invoice + LineItem types
  use-mg-invoice.ts     # State hook with IndexedDB auto-save
...
```
https://mg-invoice.vercel.app?fromName=Acme&currency=PHP&vatRate=20
```
