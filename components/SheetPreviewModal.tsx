...
const PRICELIST_DATA: PriceCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'SOL-092-AC100', name: 'AC MCCB 100A', srp: '₱950', installer: '₱850', wholesale: '₱800', subdealer: '₱750' },
      { code: 'SOL-092-AC125', name: 'AC MCCB 125A', srp: '₱950', installer: '₱850', wholesale: '₱800', subdealer: '₱750' },
