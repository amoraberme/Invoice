...
const PRICELIST_DATA: PriceCategory[] = [
  ...
  },
  {
    ...
    icon: Battery,
    warranty: 'Deye: 10 Yrs | CESC: 10 Yrs | GoodWe: 5 Yrs (10 Yrs when paired with GoodWe Inverter) | Genix: 5 Yrs | Dyness: 5 Yrs | Ubetter: 5 Yrs',
    items: [
      ...
      { code: 'UB-48V-410AH', name: 'Ubetter Battery 48V 410Ah (19.68kWh)', srp: '₱145,000', installer: '₱138,000', wholesale: '₱138,000', subdealer: '₱135,000' },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'ACC08', name: 'Battery Cable 70mm² Red/Black (Per Meter)', srp: '₱850/m', installer: '₱820/m', wholesale: '₱800/m', subdealer: '₱780/m' },
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'SOL-092-AC100', name: 'AC MCCB 100A', srp: '₱1,400', installer: '₱1,300', wholesale: '₱1,250', subdealer: '₱1,200' },
      { code: 'SOL-092-AC125', name: 'AC MCCB 125A', srp: '₱1,400', installer: '₱1,300', wholesale: '₱1,250', subdealer: '₱1,200' },
