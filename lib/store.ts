...
export const SOLAR_PRICELIST_2026: PriceListItem[] = [
  ...
  },
  {
    ...
    keywords: ['battery cable 70mm', '70mm battery cable', '70mm cable', 'battery wire 70mm'],
    meterPrice: 820,
    rollPrice: 82000,
    meterUnit: 'Meters',
    rollUnit: 'Roll',
  ...
  {
    code: 'SOL-050-32',
    name: 'Flexible hose 32mm',
    keywords: ['flexible hose 32mm', '32mm flexible hose', 'hdpe pipe 32mm', '32mm hdpe', 'flexcon 32mm'],
    meterPrice: 95,
    rollPrice: 4750,
    meterUnit: 'M',
    rollUnit: 'Roll',
  ...
  },
  {
    code: 'SOL-092-AC100',
    name: 'AC MCCB 100A',
    keywords: ['ac mccb 100a', 'mccb 100a', '100a ac mccb'],
    meterPrice: 1300,
    rollPrice: 1300,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  },
  {
    code: 'SOL-092-AC125',
    name: 'AC MCCB 125A',
    keywords: ['ac mccb 125a', 'mccb 125a', '125a ac mccb'],
    meterPrice: 1300,
    rollPrice: 1300,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  ...
  },
  {
    code: 'SOL-152',
    name: 'Ground Wire',
    keywords: ['ground wire', 'grounding wire', 'ground wire #8', 'ground wire 6mm²', 'ground wire 10mm²', 'ground wire #8 awg', '#8 ground wire'],
    meterPrice: 5888 / 150,
    rollPrice: 5888,
    meterUnit: 'Meters',
    rollUnit: 'Roll',
  ...
  },
  {
    ...
    keywords: ['dc mccb 100a', 'dc mccb 100a 2-pole', 'mccb for battery 100a', 'dc mccb 100a for battery'],
    meterPrice: 2500,
    rollPrice: 2500,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  },
  {
    ...
    keywords: ['dc mccb 125a', 'dc mccb 125a 2-pole', 'mccb for battery 125a', 'dc mccb 125a for battery'],
    meterPrice: 2500,
    rollPrice: 2500,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  },
  {
    ...
    keywords: ['dc mccb 160a', 'dc mccb 160a 2-pole', 'mccb for battery 160a', 'dc mccb 160a for battery'],
    meterPrice: 2500,
    rollPrice: 2500,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  },
  {
    ...
    keywords: ['dc mccb 200a', 'dc mccb 200a 2-pole', 'mccb for battery 200a', 'dc mccb 200a for battery'],
    meterPrice: 2500,
    rollPrice: 2500,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  },
  {
    ...
    keywords: ['dc mccb 250a', 'dc mccb 250a 2-pole', 'mccb for battery 250a', 'dc mccb 250a for battery'],
    meterPrice: 2500,
    rollPrice: 2500,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  ...
  {
    code: 'TWMNH-66HD625',
    name: 'Tongwei 625W Bifacial Solar Panel',
    keywords: ['tongwei 625w', 'tongwei panel 625w', 'tongwei 625', 'tw 625w', 'tw panel 625w', 'tongwei bifacial 625w'],
    meterPrice: 5418,
    rollPrice: 5418,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
  ...
  {
    code: 'TWMNH-66HD620',
    name: 'Tongwei 620W Bifacial Solar Panel',
    keywords: ['tongwei 620w', 'tongwei panel 620w', 'tongwei 620', 'tw 620w', 'tw panel 620w', 'tongwei bifacial 620w'],
    meterPrice: 5456,
    rollPrice: 5456,
    meterUnit: 'PCS',
    rollUnit: 'PCS',
